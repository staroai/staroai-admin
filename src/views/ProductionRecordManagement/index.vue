...
const search = (page = 1) => {
  getAgentChatMessageRecords({
    ...
    tableData.value = res.agentChatMessageRecords;
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="userMessage" label="Q" width="" />
      <el-table-column prop="agentResponse" label="A" width="" />
